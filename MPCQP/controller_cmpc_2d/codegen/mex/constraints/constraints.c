...
static emlrtRTEInfo h_emlrtRTEI = { 5, /* lineNo */
  1,                                   /* colNo */
  "constraints",                       /* fName */
  "/Users/Usama/UmehmoodGoogle/Work/Code/Swarms New/MPCQP/controller_cmpc_2d/common/constraints.m"/* pName */
};
...
void constraints(const emlrtStack *sp, const real_T u[180], const struct0_T
